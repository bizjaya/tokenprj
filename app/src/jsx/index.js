...
import RefRewards from "./components/RefRewards/RefRewards.js";
import Statz from "./components/Statz/Statz.js";
import MyNetwork from "./components/MyNetwork/MyNetwork.js";
import HistRewards from "./components/History/HistRewards";
import HistStaking from "./components/History/HistStaking";
...
const Markup = () => {
  ...
  const routes = [
    ...
    { url: "ref/:id", component: Home },

    { url: "staking", component: Staking },
    { url: "community-rewards", component: RefRewards },
    { url: "rewards-history", component: HistRewards },
    { url: "staking-history", component: HistStaking },

    { url: "community-rewards", component: RefRewards },

    { url: "community/:id", component: MyNetwork },
    { url: "statz", component: Statz },
